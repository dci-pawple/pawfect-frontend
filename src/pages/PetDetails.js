...
const PetDetails = () => {
    ...
    return (
        <div className="app-container container pet__container">
            ...
            <Carousel itemsToShow={3} breakPoints={breakPoints} className="pet__gallery-container">
            ...
            <div className="pet__content-container">
                <div className="pet__info-container">
                    ...
                    <div className="pet__info-data-about">
                        ...
                        <p>Henry enjoys playing in the yard and going for walks around the neighborhood. Her foster is working on her leash training so an adopter would need to be committed to continuing to work with her to walk nicely on leash when she sees squirrels. Henry also must be the only pet in the home, she cannot live with other dogs or cats. Henry would love an adopter where she was the central pet in their lives and would much prefer to be with her people than other animals so she will not be a dog park or play date type dog but will love you endlessly if you do the same!</p>
                    </div>
                </div>
